...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn('bg-zinc-950/80 text-zinc-400 font-medium uppercase tracking-wider text-[10px]', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn('divide-y divide-zinc-800 text-zinc-300', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-10 px-4 text-left align-middle font-semibold text-zinc-400 [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
